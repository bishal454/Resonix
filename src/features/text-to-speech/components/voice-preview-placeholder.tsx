    ...
    <div className="hidden flex-1 lg:flex h-full flex-col items-center justify-center gap-6 border-t">
      <div className="flex flex-col items-center gap-3">
        <div className="relative flex w-32 items-center justify-center">
          ...
          <p className="text-lg font-semiblod tracking-tight text-foreground">
            Preview will appear here
          </p>
          < p className="max-64 text-center text-sm text-muted-foreground">
          Once you Generate , your audio result will appear here
          
          </p>
          </div>
          <Button variant="outline" size="sm" asChild>
            <Link href="mailto:bishalranjan44@gmail.com">
            <BookOpen />
            Don&apos;t know how?
            </Link>
